...
function IntelligenceSkeleton() {
  ...
  return (
    <div className="bg-intel-panel rounded-2xl border border-surface-border px-5 py-3 flex items-center gap-3">
      <span className="text-base flex-shrink-0">🧠</span>
      <span className="text-sm font-semibold text-gray-400 flex-shrink-0">Sprint Intelligence</span>
      <div className="flex-1 h-1.5 rounded-full overflow-hidden bg-surface mx-1">
        <div className="h-full w-3/5 rounded-full animate-pulse"
          style={{ background: 'linear-gradient(90deg,#4c6ef580,#818cf8cc)' }} />
      </div>
      <span className="text-xs text-brand-400 flex-shrink-0">{THINKING_STEPS[step]}</span>
    </div>
  );
}
